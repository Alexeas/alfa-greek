...
title[2]       = 'Прилагательные. Склонение прилагательных. Окончение -ος, -υς, -ης, -η, -α, -ια, -ο, -υ, ι, -ικο, -ες.';
...
title[6]       = 'Существительные. Имя существительное. Род, число, склонение, падеж.';
description[6] = 'Существительные в Греческом языке.';
address[6]     = '../grammar/nouns.html';

title[7]       = 'Существительные. Cклонение существительных. Женский род. Окончание -η, -α.';
description[7] = 'Cклонение существительных Женского рода в Греческом языке.';
address[7]     = '../grammar/nounsdeclension_f.html';

title[8]       = 'Существительные. Cклонение существительных. Мужской род. Окончание -ος, -ης, -ας.';
description[8] = 'Cклонение существительных Мужского рода в Греческом языке.';
address[8]     = '../grammar/nounsdeclension_m.html';

title[9]       = 'Существительные. Cклонение существительных. Средний род. Окончание -ο, -ι, -μα, -υ.';
